...
export class ViperService {
    ...
    //     const session: Session | null = await this.viperRepository.getSession()
    //     return session
    // }
    ...
    async preloadGetByIdBasicProps(viperId: string): Promise<void> {
        void this.getByIdBasicProps(viperId)
    }
