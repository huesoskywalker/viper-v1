...
export const createBlog = async (
    ...
    const blogContent: ModifyResult<Viper> = await viperCollection.findOneAndUpdate(
        {
            _id: dataBase.createObjectId(viperId),
        },
        {
...
export const addFollow = async (
        ...
        $or: [
            {
                members: [
                    ...
                    dataBase.createObjectId(currentViperId),
                ],
            },
            {
                members: [
    ...
    const follower: Promise<ModifyResult<Viper>> = viperCollection.findOneAndUpdate(
        {
            _id: dataBase.createObjectId(viperId),
        },
        {
    ...
    const follows: Promise<ModifyResult<Viper>> = viperCollection.findOneAndUpdate(
        {
...
export const commentBlog = async (
    ...
    const commentBlog: ModifyResult<Viper> = await viperCollection.findOneAndUpdate(
        {
            _id: dataBase.createObjectId(blogOwner_id),
