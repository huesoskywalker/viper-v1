...
//     const editedEvent: WithId<Event> | null = await eventCollection.findOneAndUpdate(
//         {
...
//             },
//             {
//                 $match: { "comments.likes._id": new ObjectId(viperId) },
//             },
//             {
//                 $project: { _id: 0, "comments.likes._id": 1 },
//             },
//         ])
//         .toArray()
//     return isLiked ? true : false
