...
import { type LatLngLiteral, type MapOptions, type MapContainer } from "@/types/google-maps-api"
...
function MapComponent({ properties }: { properties: any }): JSX.Element {
    // check all the component and make it cool
